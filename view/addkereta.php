...
<body>
  <nav class="navbar navbar-expand-lg bg-body-tertiary">
    ...
    <form action="addkereta.php" method="post" name="form1">
        <table width="25%" border="0">
            ...
            <tr>
                ...
                <select class="form-select" name="daftarstasiun" class="form-select">
    ...
    if(isset($_POST['Submit'])) {
        ...
        $result = mysqli_query($mysqli, "INSERT INTO kereta(id_kereta,id_stasiun,nama_kereta,asal,tujuan,kelas,harga) VALUES('$id_kereta','$id_stasiun','$nama_kereta','$asal','$tujuan','$kelas','$harga')");
        
        echo "Trains added successfully. <a href='indexkereta.php'>View Trains</a>";
    }
    ?>
</body>
</html>